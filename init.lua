...
local function show_box(s, map, name)
	...
	if ( name == "MPC" ) then
		label = "<span foreground='" .. beautiful.bg_normal .. "' background='" .. beautiful.modebox_cyan .. "'> " .. name .. " </span> "
	elseif ( name == "NETWORK" ) then
		label = "<span foreground='" .. beautiful.bg_normal .. "' background='" .. beautiful.modebox_green .. "'> " .. name .. " </span> "
	elseif ( name == "POWER" ) then
		label = "<span foreground='" .. beautiful.bg_normal .. "' background='" .. beautiful.modebox_red .. "'> " .. name .. " </span> "
	elseif ( name == "ROFI" ) then
		label = "<span foreground='" .. beautiful.bg_normal .. "' background='" .. beautiful.modebox_yellow .. "'> " .. name .. " </span> "
	elseif ( name == "TAG" ) then
		label = "<span foreground='" .. beautiful.bg_normal .. "' background='" .. beautiful.modebox_magenta .. "'> " .. name .. " </span> "
	else
		label = "<span foreground='" .. beautiful.bg_normal .. "' background='" .. beautiful.modebox_blue .. "'> " .. name .. " </span> "
	end
	...
	mbox.height = settings.height or defaults.height
	mbox.width = math.ceil(s.workarea.width - 95)
